	...
	<div class="page-titles">
		<div class="row">
			<div class="col-lg-8 col-md-6 col-12 align-self-center">
				...
				<h1 class="mb-0 fw-bold">Tambah Prodi</h1>
			</div>
		</div>
	</div>
	<!-- ============================================================== -->
				...
				<div class="card">
					<div class="card-body">
						...
						<h5 class="card-subtitle mb-3 pb-3 border-bottom">
							silahkan input untuk menambahkan Program Studi
						</h5>
						<form autocomplete="off" method="POST" action="<?= base_url('admin/tambah_prodi_aksi') ?>">
							<div class="form-floating mb-3">
								<select class="form-select border border-info" name="fakultas" aria-label="Floating label select example">
									<option value="">Pilih Fakultas</option>
									<?php foreach ($fakultase as $fakultas) : ?>
