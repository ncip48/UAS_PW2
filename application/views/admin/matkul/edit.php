	...
	<div class="page-titles">
		<div class="row">
			<div class="col-lg-8 col-md-6 col-12 align-self-center">
				...
				<h1 class="mb-0 fw-bold">Edit Matkul</h1>
			</div>
		</div>
	</div>
	<!-- ============================================================== -->
				...
				<div class="card">
					<div class="card-body">
						...
						<h5 class="card-subtitle mb-3 pb-3 border-bottom">
							silahkan input untuk mengedit Matkul
						</h5>
						<form autocomplete="off" method="POST" action="<?= base_url('admin/edit_matkul_aksi') ?>">
							<input type="hidden" class="form-control border border-info" name="id" placeholder="ID" value="<?= $matkul->id ?>">
							<div class="form-floating mb-3">
								<input type="text" class="form-control border border-info" name="nama_matkul" placeholder="Nama Matkul" value="<?= $matkul->nama_matkul ?>">
								<label>
