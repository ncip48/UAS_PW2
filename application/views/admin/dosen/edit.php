				...
				<div class="card">
					<div class="card-body">
						...
						<h5 class="card-subtitle mb-3 pb-3 border-bottom">
							silahkan input untuk mengedit user
						</h5>
						<form autocomplete="off" method="POST" action="<?= base_url('admin/edit_user_aksi') ?>">
							<div class="form-floating mb-3">
								<input type="hidden" class="form-control border border-info" name="id" placeholder="ID" value="<?= $user->id ?>">
								<input type="email" class="form-control border border-info" name="email" placeholder="Email" value="<?= $user->email ?>">
								<label>
							...
							<div class="form-floating mb-3">
								<input type="text" class="form-control border border-info" name="nama" placeholder="Nama" value="<?= $user->nama ?>">
								<label>
							...
							<div class="form-floating mb-3">
								<select class="form-select border border-info" name="id_dosen" aria-label="Floating label select example">
									...
									<?php foreach ($dosens as $dosen) : ?>
										<option value="<?= $dosen->id_dosen ?>" <?php if ($user->id_dosen == $dosen->id_dosen) {
																					echo "selected";
